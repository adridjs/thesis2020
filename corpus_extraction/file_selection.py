...
def retrieve_args():
    parser = argparse.ArgumentParser(
        description='Generates a pickle in which contains the dictionary of the samples in which all languages have the same entry')
    ...
    parser.add_argument('-s', '--save_path', required=False,
                        help='Store the class in a pickle, which will be used on the corpus_alignment module',

...
class LanguageIdentifier:
    def __init__(self, dictionary_of_names, languages, save_folder='cat/'):
        ...
        self.p = FileSelector(self.dictionary_of_names, self.languages)
...
def retrieve_args():
    parser = argparse.ArgumentParser(
        description='Generate lists of names of the selected languages by using the csv generated in Petscan, these list are stored in a folder')
    parser.add_argument('-l', '--languages', nargs='+', help='Languages in which the lists will be generated',
                        default='')
    parser.add_argument('-f', '--folder',
                        help='Folder in which the dictionaries generated by wp_api_language_search are stored',
...
def main():
    ...
    li = LanguageIdentifier(dictionary_of_names, languages, save_folder=save_folder)
    li.generate_parse()

...
class Extractor(object):
    ...
    def write_output(self, out, text):
        ...
        if options.write_json:
            ...
            # We don't use json.dump(corpus_name, out) because we want to be
...
class OutputSplitter(object):
    ...
    def __init__(self, nextFile, max_file_size=0, compress=True):
        ...
        :para compress: whether to write corpus_name with bzip compression.
        """
...
def process_dump(input_file, template_file, out_file, file_size, file_compress,
    ...
    :param out_file: directory where to store extracted corpus_name, or '-' for stdout
    ...
    # - a reduce process collects the aligned, sort them and print them.

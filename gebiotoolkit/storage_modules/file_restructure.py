...
def retrieve_args():
    ...
    parser.add_argument("-f,""--filename", dest='filename', help="path to corpus generated by corpus_alignment module",
                        default='../corpus_alignment/aligned/')
    parser.add_argument("-o,""--output", dest='output', help="output file where the restructured files will be saved",
                        default='/restructured_files/')

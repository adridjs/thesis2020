...
## DataDriver
To parse and filter the sentences generated by `align.py` and get a gender-balanced dataset, execute the following
 command:
 #TODO: tables with arguments and its default value
```
python3 generate.py -l es en -f ../gebiotoolkit/corpus_alignment/aligned/ -s /data -d balanced
```

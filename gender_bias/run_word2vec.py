...
def retrieve_args():
    ...
    parser.add_argument("-cp", "--corpus_name-folder", dest='corpus_folder',
                        default='../translation/corpus_name',
                        help="path to the folder containing corpus_name")
    ...
    parser.add_argument("-e", "--n-epochs", dest='n_epochs',
                        default=4,
                        help='number of times each word is seen by the model when training.')
    ...
    parser.add_argument("-d", "--corpus", dest='corpus',
                        default='EuroParl',
                        help='name of the corpus used as input for the word embeddings '
